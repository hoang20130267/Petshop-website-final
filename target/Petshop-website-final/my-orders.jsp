        ...
        <div class="row">
            <div class="col-md-8 checkout__order" style="margin: auto;">
                ...
                <table class="table table-sm fs--1 mb-0">
                    <thead>
                    <tr>
                        <th class="sort align-middle pe-5" scope="col" data-sort="total-spent" style="width:20%;">Mã
                            Đơn
                        </th>
                        <th class="sort align-middle pe-5" scope="col" data-sort="email" style="width:20%;">Tổng tiền
                        </th>
                        <th class="sort align-middle pe-5" scope="col" data-sort="email" style="width:20%;">Ngày đặt
                        </th>
                        <th class="sort align-middle " scope="col" data-sort="total-orders" style="width:30%">Trạng
                            thái
                        </th>
                        <th class="sort align-middle " scope="col" data-sort="total-orders" style="width:20%">Chi tiết
                        </th>
                    </tr>
                    </thead>
