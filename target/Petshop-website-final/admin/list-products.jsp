        ...
        <div class="row">
            <div class="mb-9">
                <div class="row g-2 mb-4">
                    <div class="">
                        <h2 class="" style="margin-top: 20px; text-align: center;">Danh sách thú cưng</h2>
                    </div>
                </div>
                ...
                <table id="product-table" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                    <%
                        List<Product> list = ProductService.getInstance().getDataProductAdmin();
                        for (Product i : list) {%>
                    <tr>
                        ...
                        <td class="customer align-middle white-space-nowrap pe-5"><a class="d-flex align-items-center" href="#!">
                            <p class="mb-0 ms-3 text-1100 fw-bold"><img src="<%=i.getImage()%>" style="height: 60px; width: 60px; object-fit: cover"></p></a></td>
                        ...
                        <td class="total-spent align-middle white-space-nowrap fw-bold ps-3"><%=ProductService.getInstance().getQuantityProduct(i.getProductId())%></td>
                        <td>
                            <%
                                for (AdminRole role : admin.getRole()) {
