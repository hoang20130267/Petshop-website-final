...
public class GenerateBillPDF extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            BaseFont unicodeFont = BaseFont.createFont("D:\\ThucTapLTWeb\\Petshop-website-final\\src\\main\\java\\vn\\edu\\hcmuaf\\fit\\Arial Unicode MS.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
