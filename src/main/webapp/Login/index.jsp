              ...
              <div class="form-block">
                ...
                <form action="#" method="post">
                  ...
                  <div class="d-flex mb-5 align-items-center">
                    ...
                    <span class="ml-auto"><a href="../ForgetPass/index.jsp" class="forgot-pass">Quên mật khẩu</a></span>
                  </div>
                  ...
                  <div class="social-login text-center">
                    ...
                    <span class="d-block text-center my-4 text-muted"><a href="../SignUp/index.jsp" style="width: 60px; color: #6c757d;">Đăng kí</a> </span>
                  </div>
                </form>
              </div>
            </div>
