...
<!-- [ Header ] end -->
<%List<Detail> list = DetailService.getInstance().listCategoryParentBl();%>
<!-- [ Main Content ] start -->
    ...
    <div class="row">
      <main class="main" id="top">
        <div class="container-fluid px-0" data-layout="container">
          <form class="mb-9" method="post" action="AddCategoryBlog">
            <% Detail cateb = null;
              if (request.getParameter("cbid") != null)
                cateb = DetailService.getInstance().getCateProductById(request.getParameter("cbid"));
            %>
            ...
            <div class="row g-5">
              <div class="col-12 col-xl-8">
                ...
                <input class="form-control mb-5" name="catename" type="text"
                       value="<%=(cateb != null) ? cateb.getCatName() : ""%>" placeholder="Viết tên danh mục tại đây..."/>
                ...
                <select class="form-control mb-5" name="cateparent">
                  ...
                  <%for (Detail c : list) {
                    if (c.getCatID().equals(cateb.getParentID())) {%>
                ...
                <div class="col-auto">
                  ...
                  <%}%>
                  <input type="text" id="cid" name="cbid"
                         value="<%=(cateb != null) ? request.getParameter("cbid") : ""%>"
                         style="display: none">
                </div>
