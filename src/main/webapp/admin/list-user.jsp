        ...
        <div class="row">
            <div class="mb-9">
                ...
                <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">Tất cả <span
                            class="text-700 fw-semi-bold">(688)</span></a></li>
                                ...
                                <div class="search-box">
                                    <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                                        <input class="form-control search-input search" type="search"
                                               placeholder="Tìm người dùng" aria-label="Search">
                            ...
                            <table class="table table-sm fs--1 mb-0">
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="email align-middle white-space-nowrap pe-5"><a
                                            class="fw-semi-bold text-1100" href="mailto:annac34@gmail.com">linh67@gmail.com</a>
                                    </td>
                                    <td class="total-orders align-middle white-space-nowrap fw-semi-bold text-center">
                                        2
                                    </td>
                                    <td class="total-spent align-middle white-space-nowrap fw-bold text-end ps-3">
                                        60.000.000đ
                                    </td>
                                    <td class="last-order align-middle white-space-nowrap text-700 text-center"><span class="material-symbols-outlined">person_filled</span></td>

                                    <td class="last-order align-middle white-space-nowrap text-700 text-center"><span class="material-symbols-outlined">delete</span></td>

<%--                                    <td class="city align-middle white-space-nowrap text-900 ps-7">TPHCM</td>--%>
<%--                                    <td class="last-seen align-middle white-space-nowrap text-700 text-end">34 phút--%>
<%--                                        trước--%>
<%--                                    </td>--%>
