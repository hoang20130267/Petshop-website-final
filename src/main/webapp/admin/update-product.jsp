  ...
  <div class="pcoded-content">
    ...
    <div class="row">
      <main class="main" id="top">
        ...
        %>
          <form action="update-product" method="post" class="mb-9">
            <div class="row g-3 flex-between-end mb-5">
              <div class="col-auto">
                <h2 class="mb-2">Chỉnh sửa thông tin thú cưng</h2>
            ...
            <div class="row g-5">
              <div class="col-12 col-xl-8">
                <input id="tenthucung" name="name"
                       class="form-control mb-5"
                       type="text" placeholder="Viết tên thú cưng tại đây..." value="<%=p.getProductName()%>"
                       >
                <div class="mb-6">
                        ...
                        <div class="row g-3">
                          <div class="col-12 col-lg-6">
                            ...
                            <input name="price"
                                   class="form-control"
                                   type="text"
                                   placeholder="Đồng" value="<%=p.getPrice()%>"
                            />
                          </div>
                          <div class="col-12 col-lg-6">
                          ...
                          <div class="col-12 col-sm-6 col-xl-12">
                            <div class="mb-4">
                              <div class="d-flex flex-wrap justify-content-between mb-2">
                                <h5>Loại thú cưng</h5>
                              </div><select name="giong" class="form-select mb-3" aria-label="category">
                              <option value=""><%=p.getGiong()%></option>
