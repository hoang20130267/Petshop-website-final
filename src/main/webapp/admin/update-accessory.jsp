    ...
    <div class="row">
      <main class="main" id="top">
        <div class="container-fluid px-0" data-layout="container">
          ...
          <form action="update-accessory" method="post" class="mb-9">
            <div class="row g-3 flex-between-end mb-5">
              <div class="col-auto">
                <h2 class="mb-2">Chỉnh sửa thông tin phụ kiện</h2>
                <!-- <h5 class="text-700 fw-semi-bold">
                  Orders placed across your store
                </h5> -->
              </div>
              <div class="col-auto">
                <input type="text" name="id" id="id" value="<%=request.getParameter("pid")%>" style="display:none;">
                <input name="id" value="<%=p.getProductId()%>" style="display:none;">
                <button value="list-accessory" class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0">
                  Xóa dữ liệu</button
                >
                <button value="update-accessory" class="btn btn-primary mb-2 mb-sm-0" type="submit">
                  Đăng phụ kiện
                </button>
              </div>
            </div>
            ...
            <div class="row g-5">
              <div class="col-12 col-xl-8">
                <input name="name" value="<%=p.getProductName()%>"
                        ...
                        <div class="row g-3">
                          <div class="col-12 col-lg-6">
                            ...
                            <input name="price"
                                   class="form-control"
                                   type="text"
                                   placeholder="Đồng" value="<%=p.getPrice()%>" required
                            />
                          </div>
                          <div class="col-12 col-lg-6">
                            ...
                            <input name="promoPrice"
                                   class="form-control"
                                   type="text"
                                   placeholder="Đồng" value="<%=p.getPromotionalPrice()%>" required
                            />
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="row g-3">
                            <div class="col-12 col-lg-6">
                              ...
                              <input name="quantity"
                                     class="form-control"
                                     type="text"
                                     placeholder="Ví dụ: 5" value="<%=p.getQuantity()%>" required
                              />
                            </div>
